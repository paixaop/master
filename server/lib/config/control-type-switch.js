...
serverConfig.controls.types["switch"] = {
    ...
    // without an external system knowing about which internal property is being manipulated
    // For example it is self explanatory that a Swith has the ON and OFF position
    // 
    basic: {
        commands: [
            "ON", "OFF"
        ...
        // By default any property that is set via a basic command is considered writable
        set_property: "state",
